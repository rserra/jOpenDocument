...
public abstract class OOXML implements Comparable<OOXML> {
    ...
    /**
     * If this system property is set to <code>true</code> then
     * {@link #get(XMLFormatVersion)} will never return <code>null</code>,
     ...
     * @return the corresponding instance, <code>null</code> for unsupported
     * versions.
    ...
    /**
     * Verify that the passed document is a valid OpenOffice.org 1 or ODF
     * document.
     *
     * @param doc the XML to test.
     * @param ignoreForeign <code>true</code> to ignore unknown mark up, e.g.
     * "extended document" in OpenDocument v1.2 §2.2.2 and in OpenDocument v1.1
     * §1.5.
     ...
     *
     * @return at index 0 the name of the container element, at 1 the qualified
     * name of its children.
     */
     ...
     *
     * @return the name of the children of {@link #getOfficeScripts()} defining
     * scripts.
     */
     ...
     *
     * @return the name of the child of {@link #getOfficeScripts()} defining
     * event listeners.
     */
     ...
     * @param styles the mapping from tagname (eg "b") to the name of the
     * character style (eg "Gras").
    ...
    /**
     * Encode a String to OO XML. Handles substition of whitespaces to their OO
     * equivalent.
     *
    ...
    /**
     * Return the coordinates of the top-left and bottom-right of the passed
     * shape.
     *
     * @param elem an XML element.
     * @param unit the unit of the returned numbers.
     * @return an array of 4 numbers, <code>null</code> if <code>elem</code> is
     * not a shape, numbers themselves are never <code>null</code>.
     */
     ...
     * @param elem an XML element.
     * @param unit the unit of the returned numbers.
     * @param horizontal <code>true</code> if the x coordinates should be
     * computed, <code>false</code> meaning items 0 and 2 of the result are
     * <code>null</code>.
     * @param vertical <code>true</code> if the y coordinates should be
     * computed, <code>false</code> meaning items 1 and 3 of the result are
     * <code>null</code>.
     * @return an array of 4 numbers, <code>null</code> if <code>elem</code> is
     * not a shape, numbers themselves are only <code>null</code> if requested
     * with <code>horizontal</code> or <code>vertical</code>.
     */
    ...
    private static final class XML_OD_1_3 extends XML_OD {
        ...
        public XML_OD_1_3() {
            super("20110317", "1.3", "OpenDocument-v1.3-schema.rng", "OpenDocument-v1.3-manifest-schema.rng");
        }
